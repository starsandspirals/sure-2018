 ...
 *
 */
__global__ void GPUFLAME_infect(xmachine_memory_Person_list* agents, xmachine_message_infection_list* infection_messages, RNG_rand48* rand48){
	...
	//FLAME function call
	int dead = !infect(&agent, infection_messages, rand48);
