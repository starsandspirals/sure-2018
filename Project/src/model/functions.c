...
__FLAME_GPU_INIT_FUNC__ void initialiseHost()
{
  ...
  h_tbassignment_AoS = h_allocate_agent_TBAssignment_array(h_tbassignment_AoS_MAX);
  h_hhmembership_AoS = h_allocate_agent_HouseholdMembership_array(h_hhmembership_AoS_MAX);
  h_chumembership_AoS = h_allocate_agent_ChurchMembership_array(h_chumembership_AoS_MAX);
  h_trmembership_AoS = h_allocate_agent_TransportMembership_array(h_trmembership_AoS_MAX);
